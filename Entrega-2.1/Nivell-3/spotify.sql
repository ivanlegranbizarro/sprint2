...
(
  ...
  sexe           ENUM('home','dona','trans','no-binari','no-respon') NOT NULL,
...
ALTER TABLE Subscripcio
  ADD CONSTRAINT FK_Usuari_TO_Subscripcio
    FOREIGN KEY (id_usuari)
    REFERENCES Usuari (id);

ALTER TABLE Subscripcio
  ADD CONSTRAINT FK_Pagament_TO_Subscripcio
    FOREIGN KEY (id_pagament)
    REFERENCES Pagament (id);

ALTER TABLE PayPal
  ADD CONSTRAINT FK_Usuari_TO_PayPal
    FOREIGN KEY (id_usuari)
    REFERENCES Usuari (id);

ALTER TABLE Playlist
  ADD CONSTRAINT FK_Usuari_TO_Playlist
    FOREIGN KEY (id_usuari)
    REFERENCES Usuari (id);

ALTER TABLE Playlist
  ADD CONSTRAINT FK_Cançons_TO_Playlist
    FOREIGN KEY (id_canço)
    REFERENCES Cançons (id);

ALTER TABLE Album
  ADD CONSTRAINT FK_Cançons_TO_Album
    FOREIGN KEY (id_canço)
    REFERENCES Cançons (id);

ALTER TABLE Album
  ADD CONSTRAINT FK_Artista_TO_Album
    FOREIGN KEY (id_artista)
    REFERENCES Artista (id);

ALTER TABLE Seguir_Artista
  ADD CONSTRAINT FK_Artista_TO_Seguir_Artista
    FOREIGN KEY (id_artista)
    REFERENCES Artista (id);

ALTER TABLE Seguir_Artista
  ADD CONSTRAINT FK_Usuari_TO_Seguir_Artista
    FOREIGN KEY (id_usuari)
    REFERENCES Usuari (id);

ALTER TABLE cançons_favorites
  ADD CONSTRAINT FK_Cançons_TO_cançons_favorites
    FOREIGN KEY (id_canço)
    REFERENCES Cançons (id);

ALTER TABLE cançons_favorites
  ADD CONSTRAINT FK_Usuari_TO_cançons_favorites
    FOREIGN KEY (id_usuari)
    REFERENCES Usuari (id);

ALTER TABLE albums_favorits
  ADD CONSTRAINT FK_Album_TO_albums_favorits
    FOREIGN KEY (id_album)
    REFERENCES Album (id);

ALTER TABLE albums_favorits
  ADD CONSTRAINT FK_Usuari_TO_albums_favorits
    FOREIGN KEY (id_usuari)
    REFERENCES Usuari (id);